...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, use_att=False, att_mode='Botox'):
        self.inplanes = 64
	...
	if use_att:
	    self.att = BotoxNet(512*block.expansion)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, use_att=False, att_mode='Botox'):
        downsample = None
